...
(Business_Role)-[:PARTICIPATES]->(Value_Stage)-[:SUPERSEDES]->(Value_Stage)-[:SUPERSEDED_BY]->(Value_Stage)-[:REQUIRES]->(Business_Capability)-[:REQUIRED_BY]->(Value_Stage)<-[:PARTICIPATES]-(`Business_Role_Type `)<-[:PARTICIPATED_BY]-(Value_Stage)-[:PARTICIPATED_BY]->(Business_Role)-[:SUPERSEDES]->(Business_Role)-[:SUPERSEDED_BY]->(Business_Role)-[:RAISES]->(External_Business_Event:Business_Logical)-[:RAISED_BY]->(Business_Role),
...
(Product_Type)-[:INSTANCES]->(:Business_Logical)-[:INSTANCE_OF]->(Product_Type),
(Business_Process_Type:Business_Logical)-[:BELONGS_TO]->(:Business_Logical)-[:CONTAINS]->(Business_Process_Type)-[:SUPPORTS]->(Value_Stage)-[:SUPPORTED_BY]->(Business_Process_Type)
```
...
path8 = (Business_Role)-[:PARTICIPATES]->(Value_Stage)-[:SUPERSEDES]->(Value_Stage)-[:SUPERSEDED_BY]->(Value_Stage)-[:REQUIRES]->(Business_Capability)-[:REQUIRED_BY]->(Value_Stage)<-[:PARTICIPATES]-(`Business_Role_Type `)<-[:PARTICIPATED_BY]-(Value_Stage)-[:PARTICIPATED_BY]->(Business_Role)-[:SUPERSEDES]->(Business_Role)-[:SUPERSEDED_BY]->(Business_Role)-[:RAISES]->(External_Business_Event:Business_Logical)-[:RAISED_BY]->(Business_Role),
...
path11 = (Product_Type)-[:INSTANCES]->(:Business_Logical)-[:INSTANCE_OF]->(Product_Type),
path12 = (Business_Process_Type:Business_Logical)-[:BELONGS_TO]->(:Business_Logical)-[:CONTAINS]->(Business_Process_Type)-[:SUPPORTS]->(Value_Stage)-[:SUPPORTED_BY]->(Business_Process_Type)
RETURN path0, path1, path2, path3, path4, path5, path6, path7, path8, path9, path10, path11, path12
```
...
MERGE (Product_Type)-[:INSTANCES]->(:Business_Logical)-[:INSTANCE_OF]->(Product_Type)
MERGE (Business_Process_Type:Business_Logical)-[:BELONGS_TO]->(:Business_Logical)-[:CONTAINS]->(Business_Process_Type)-[:SUPPORTS]->(Value_Stage)-[:SUPPORTED_BY]->(Business_Process_Type)
```