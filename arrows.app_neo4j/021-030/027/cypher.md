...
(Physical_Process)-[:MEMBERS_OF]->(Physical_Process_Type:Business_Phyiscal)<-[:MEMBERS_OF]-(:Business_Phyiscal),
(Physical_Process_Type)-[:IMPLEMENTS]->(Product)-[:IMPLEMENTED_BY]->(Physical_Process_Type)
```
...
path14 = (Physical_Process)-[:MEMBERS_OF]->(Physical_Process_Type:Business_Phyiscal)<-[:MEMBERS_OF]-(:Business_Phyiscal),
path15 = (Physical_Process_Type)-[:IMPLEMENTS]->(Product)-[:IMPLEMENTED_BY]->(Physical_Process_Type)
...
MERGE (Physical_Process)-[:MEMBERS_OF]->(Physical_Process_Type:Business_Phyiscal)<-[:MEMBERS_OF]-(:Business_Phyiscal)
MERGE (Physical_Process_Type)-[:IMPLEMENTS]->(Product)-[:IMPLEMENTED_BY]->(Physical_Process_Type)
```