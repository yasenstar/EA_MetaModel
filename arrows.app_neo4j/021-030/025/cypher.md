...
(Business_Process_Type)-[:BELONGS_TO]->(:Business_Logical)-[:CONTAINS]->(Business_Process_Type)-[:SUPPORTS]->(Value_Stage)-[:SUPPORTED_BY]->(Business_Process_Type)
```
...
path12 = (Business_Process_Type)-[:BELONGS_TO]->(:Business_Logical)-[:CONTAINS]->(Business_Process_Type)-[:SUPPORTS]->(Value_Stage)-[:SUPPORTED_BY]->(Business_Process_Type)
...
MERGE (Business_Process_Type)-[:BELONGS_TO]->(:Business_Logical)-[:CONTAINS]->(Business_Process_Type)-[:SUPPORTS]->(Value_Stage)-[:SUPPORTED_BY]->(Business_Process_Type)
```